	...
	<body class="bg-gray-50 h-screen <%=dir%>" onload="fillDocName();">
				...
				<div class="grid grid-cols-1 space-y-4" >
					...
					<div class="grid grid-cols-1 space-y-2">
						...
						<div class="float-wrapper relative">
							...
							<select id="documentType" class="input input-md" value="${docType.key}" onchange="setDocName(this);" name="selectDocTypeList" >
							...
							<label for="documentType" class="label float-label"><fmt:message key="label.selectDocType" /></label>
						</div>
						...
						<div class="float-wrapper relative">														
							...
							<select id="personRequest" class="input input-md" name="selectRequestList" >								
								<c:forEach var="personRequest" items="${sessionScope.personRequests}">
									<option value="${personRequest.key}">${personRequest.value}</option>
								</c:forEach>
							</select>
							<label for="personRequest" class="label float-label" ><fmt:message key="label.selectRequest" /></label>
						</div>
		...
		<script>
			...
			function fillDocName(){
				console.log("ScanDocument.jsp:script:functions:fillDocName");
				const e = document.getElementById("documentType");
